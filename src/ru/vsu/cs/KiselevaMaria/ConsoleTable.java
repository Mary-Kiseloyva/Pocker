...
public class ConsoleTable {
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (true) {
          ...
          /*  for(Player player: players){//нужно только пока для демонстрации
            ...
            System.out.println("победитель " + winner.getPlayer().getName());
            System.out.println("лучшая комбинация " + winner.getCombination());
    ...
    private static Candidate findWinner(List<Player> players, List<Card> cards) {
    ...
    private static void compareWithWinner(Player player, Candidate winner) {
    ...
    private static void findWinner(Candidate winner, Candidate candidate) {
    ...
    private static void findOrSetWinner(Candidate winner, Candidate candidate) {
    ...
    private static boolean isPriorityBigger(Candidate winner, Candidate candidate) {
        return candidate.getCombination().getPriority() >
                winner.getCombination().getPriority();
    }

    private static boolean isPriorityTheSameAndCardsBetter(Candidate winner, Candidate candidate) {
        return candidate.getCombination().getPriority() ==
                winner.getCombination().getPriority() &&
    ...
    private static void setWinner(Candidate winner, Candidate candidate) {
